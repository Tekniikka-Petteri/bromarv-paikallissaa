...
- Hintakaaviossa nykyinen ja päivän halvin tunti korostetaan selvästi.
- Lisätty automaattinen tulkinta siitä, kuuluuko nykyinen hinta päivän halvimpaan, keskimmäiseen vai kalleimpaan hintatasoon.
- Sähköhintatieto välimuistitetaan 12 tunniksi. Jos hintapalvelu ei vastaa, sääsivu jatkaa normaalisti.
- Suomen- ja ruotsinkieliset sähköhintatekstit lisätty.
- v61:n 8 tunnin ja 3 vuorokauden ennuste, sää-, meri-, kamera-, peikko- ja SEO-toiminnot säilytetty.
