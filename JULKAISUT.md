...
- 8 tunnin ennuste säilyy ennallaan.
- Uusi 3 vuorokauden malliennuste näyttää huomisen ja kaksi seuraavaa päivää.
- Päiväkortit: min/max-lämpötila, säätila, saderiski, sademäärä ja tuuli.
- Ennuste perustuu MET Norwayn samaan säädataan kuin nykyinen ydinsää.
