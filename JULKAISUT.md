...
## Versio 53 – 19.8.2026
- Rakennettu uudelleen käyttäjän toimivaksi todetun version 52 paketista.
- Lisätty uusi Bromarvin satamaa sekä Mille- ja Nille-peikkoja esittävä hero-kuva `Bromarv nyt` -korttiin.
- Peikkokuva tallennettu pakettiin sekä PNG- että WebP-muodossa, jotta kuvalinkki ei rikkoudu GitHub Pagesissa tai mobiilissa.
- Sääikoni sijoitettu omaan läpikuultavaan kapseliin.
- Yläosan lämpötilaa, säätekstiä ja sääikonia suurennettu mobiilin luettavuuden parantamiseksi.
- Version 52 kaikki toiminnallisuudet säilytetty pohjana.
